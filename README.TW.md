...
| :--------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------ | :---------------------------------------------------------------------------------------------------- |
| [`packages/material-web-snippets`](./packages/material-web-snippets)               | [Material Web Snippets](https://marketplace.visualstudio.com/items?itemName=sandlada.material-web-snippets)               | `md-*` 元件 snippets（HTML / JSX / TSX）、tag＋attribute IntelliSense，純 snippets                      |
...
```text
packages/
  material-web-snippets/        # sandlada.material-web-snippets（純 snippets，無程式碼；自帶 schema/＋scripts/）
...
```sh
npm run build           # 一條龍：generate -> verify
