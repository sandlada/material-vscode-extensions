...
| :--------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------ | :------------------------------------------------------------------------------------------------ |
| [`packages/material-web-snippets`](./packages/material-web-snippets)               | [Material Web Snippets](https://marketplace.visualstudio.com/items?itemName=sandlada.material-web-snippets)               | `md-*` component snippets (HTML / JSX / TSX), tag + attribute IntelliSense, snippets-only         |
...
```text
packages/
  material-web-snippets/        # sandlada.material-web-snippets (snippets-only, no code; own schema/ + scripts/)
...
```sh
npm run build           # one-stop: generate -> verify
